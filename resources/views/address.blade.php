        ...
        <section class="page-title-section bg-img cover-background" data-background="img/bg/page-title.jpg">
            <div class="container">
                ...
                <div class="title-info">
                    <h1>Contact / Shipping Address</h1></div>
                    ...
                    <div class="col-lg-4 col-sm-9 mb-2-3 mb-lg-0">
                        ...
                        <div class="account-pannel">
                            ...
                            <a class="list-group-items" href="{{url('/profile')}}"><i class="ti-user pe-2"></i>Profile</a>
                                ...
                                <a class="list-group-items active" href="{{url('/address')}}"><i class="ti-location-pin pe-2"></i>Addresses</a>
                            ...
                            <form method="post">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="company" placeholder="Your company name here">
                                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            <label>State</label>
                                            <input type="text" class="form-control" name="state" placeholder="Your state name here">
                                        </div>
                                ...
                                <button type="button" class="butn-style2 mt-4">Update Address</button>
